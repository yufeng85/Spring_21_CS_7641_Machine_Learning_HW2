...
plt.grid(True)
plt.tight_layout()
plt.savefig('4_peaks_RHC_Fitness Value VS Iterations.png',dpi=600)
...
plt.grid(True)
plt.tight_layout()
plt.savefig('4_peaks_SA_Fitness Value VS Iterations.png',dpi=600)
...
plt.grid(True)
plt.tight_layout()
plt.savefig('4_peaks_GA_Fitness Value VS Iterations.png',dpi=600)
...
plt.grid(True)
plt.tight_layout()
plt.savefig('4_peaks_MIMIC_Fitness Value VS Iterations.png',dpi=600)
...
#plt.ylim(0,40)
plt.grid(True)
plt.savefig('4_peaks_RHC_Fitness Value VS Number of Random Restarts.png',dpi=600)
...
plt.tight_layout()
plt.savefig('4_peaks_RHC_Effect of Number of Random Restarts for Randomized Hill Climbing.png',dpi=600)
...
plt.tight_layout()
plt.savefig('4_peaks_SA_Effect of Initial Temperature for GeomDecay.png',dpi=600)
...
for i in range(len(decays)):
    best_state_sa, best_fitness_sa, fitness_curve_sa = mlrose.simulated_annealing(problem, schedule = mlrose.GeomDecay(decay=decays[i],init_temp =10),
                                                      max_attempts = 5, max_iters = 1000,
                                                      init_state = init_state, curve=True, random_state = 1)
    best_state_sas.append(best_state_sa)
    best_fitness_sas.append(best_fitness_sa)
...
plt.tight_layout()
plt.savefig('4_peaks_SA_Effect of Temperature decay parameter for GeomDecay.png',dpi=600)
...
fig.legend(loc="upper right", bbox_to_anchor=(0.5,0.2), bbox_transform=ax1.transAxes)
plt.tight_layout()
plt.savefig('4_peaks_SA_Effect of Initial Temperature for ExpDecay.png',dpi=600)
...
for i in range(len(exp_consts)):
    best_state_sa, best_fitness_sa, fitness_curve_sa = mlrose.simulated_annealing(problem, schedule = mlrose.ExpDecay(exp_const=exp_consts[i],init_temp =15),
                                                      max_attempts = 5, max_iters = 1000,
                                                      init_state = init_state, curve=True, random_state = 1)
    best_state_sas.append(best_state_sa)
    best_fitness_sas.append(best_fitness_sa)
...
plt.tight_layout()
plt.savefig('4_peaks_SA_Effect of Exponential Constant Parameter for ExpDecay.png',dpi=600)
...
fig.legend(loc="upper right", bbox_to_anchor=(1,1), bbox_transform=ax1.transAxes)
plt.tight_layout()
plt.savefig('4_peaks_SA_Effect of Initial Temperature for ArithDecay.png',dpi=600)
...
fig.legend(loc="upper right", bbox_to_anchor=(1,1), bbox_transform=ax1.transAxes)
plt.tight_layout()
plt.savefig('4_peaks_SA_Effect of Temperature Decay Parameter for ArithDecay.png',dpi=600)

#===============================================================================================
schedules = [mlrose.GeomDecay(init_temp =10,decay=0.99), mlrose.ArithDecay(init_temp =2,decay=0.005), mlrose.ExpDecay(init_temp =15,exp_const=0.005)]
fitness_curve_sas = []
best_state_sas = []
best_fitness_sas = []
iteration_sa = []
...
plt.plot(fitness_curve_sas[0], label = 'GeomDecay, init_temp =10, decay=0.99', color="C0", lw=2)
plt.plot(fitness_curve_sas[1], label = 'ArithDecay, init_temp =1, decay=0.005', color="C1", lw=2)
plt.plot(fitness_curve_sas[2], label = 'ExpDecay, init_temp =15, exp_const=0.005', color="C2", lw=2)
...
plt.grid(True)
plt.tight_layout()
plt.savefig('4_peaks_SA_Fitness Value VS Iterations for Various Decay Schedules.png',dpi=600)
...
fig.legend(loc="upper right", bbox_to_anchor=(0.5,0.2), bbox_transform=ax1.transAxes)
plt.tight_layout()
plt.savefig('4_peaks_GA_Effect of Size of Population for Genetic Algorithm.png',dpi=600)

#=========================================================================================
mutation = [0.04,0.07, 0.1, 0.14, 0.17, 0.2]
fitness_curve_gas = []
best_state_gas = []
best_fitness_gas = []
iteration_ga = []
for i in range(len(mutation)):
    best_state_ga, best_fitness_ga, fitness_curve_ga = mlrose.genetic_alg(problem,
                                                      pop_size=500, mutation_prob=mutation[i],                                        
                                                      max_attempts = 100, max_iters = 1000,
                                                      curve=True, random_state = 1)
    best_state_gas.append(best_state_ga)
    best_fitness_gas.append(best_fitness_ga)
...
fig.legend(loc="upper right", bbox_to_anchor=(1,0.2), bbox_transform=ax1.transAxes)
plt.tight_layout()
plt.savefig('4_peaks_GA_Effect of Probability of Mutation for Genetic Algorithm.png',dpi=600)
...
#plt.ylim(0,40)
plt.grid(True)
plt.savefig('4_peaks_MIMIC_Fitness Value VS Size of Population.png',dpi=600)
...
fig.legend(loc="upper right", bbox_to_anchor=(1,0.2), bbox_transform=ax1.transAxes)
plt.tight_layout()
plt.savefig('4_peaks_MIMIC_Effect of Size of Population for MIMIC.png',dpi=600)
...
#plt.ylim(0,40)
plt.grid(True)
plt.savefig('4_peaks_MIMIC_Fitness Value VS Proportion of Samples to Keep.png',dpi=600)
...
fig.legend(loc="upper right", bbox_to_anchor=(1,0.2), bbox_transform=ax1.transAxes)
plt.tight_layout()
plt.savefig('4_peaks_MIMIC_Effect of Proportion of Samples to Keep for MIMIC.png',dpi=600)
...
plt.grid(True)
plt.tight_layout()
plt.savefig('4_peaks_MIMIC_Fitness Value VS Iterations for Various Keep Percentage.png',dpi=600)
...
#schedule = mlrose.ArithDecay(init_temp =1,decay=0.005)
...
plt.grid(True)
plt.tight_layout()
plt.savefig('4_peaks_Fitness Value VS Iterations for Random Optimization.png',dpi=600)
...
for i in range(len(sizes)):
    ...
    for k in range(5):
        start_rhc = time.time()
        best_state_rhc, best_fitness_rhc, fitness_curve_rhc = mlrose.random_hill_climb(problem, curve=True, restarts=30, random_state = k)
        end_rhc = time.time()
        ...
        start_sa = time.time()
        best_state_sa, best_fitness_sa, fitness_curve_sa = mlrose.simulated_annealing(problem, curve=True, random_state = k)
        end_sa = time.time()
        ...
        start_mimic = time.time()
        best_state_mimic, best_fitness_mimic, fitness_curve_mimic = mlrose.mimic(problem, pop_size=100, curve=True, random_state = k)
        end_mimic = time.time()
        best_fitness_batch_mimic.append(best_fitness_mimic)
        iteration_batch_mimic.append(len(fitness_curve_mimic))
        evaluation_batch_mimic.append(len(fitness_curve_mimic)*200)
...
plt.title('Average Fitness Value VS Problem Size for Four Peaks', y = 1.03)
plt.legend(loc=0)
plt.grid(True)
plt.tight_layout()
plt.savefig('4_peaks_Average Fitness Value VS Problem Size for Four Peaks Optimization.png',dpi=600)
#=================================================================================================
fig = plt.figure()
...
plt.xlabel('Problem Size', fontsize = 14)
plt.title('Average Iterations Value VS Problem Size for Four Peaks', y = 1.03)
plt.legend(loc=0)
plt.grid(True)
plt.tight_layout()
plt.savefig('4_peaks_Average Iterations Value VS Problem Size for Four Peaks Optimization.png',dpi=600)
...
plt.xlabel('Problem Size', fontsize = 14)
plt.title('Average Number of Evaluations VS Problem Size for Four Peaks', y = 1.03)
plt.legend(loc=0)
plt.grid(True)
plt.tight_layout()
plt.savefig('4_peaks_Average Number of Evaluations VS Problem Size for Four Peaks Optimization.png',dpi=600)
...
plt.xlabel('Problem Size', fontsize = 14)
plt.title('Average Time VS Problem Size for Four Peaks', y = 1.03)
plt.legend(loc=0)
plt.grid(True)
plt.tight_layout()
plt.yscale('log')
plt.savefig('4_peaks_Average Time VS Problem Size for Four Peaks Optimization.png',dpi=600)
...
for i in range(len(max_iters_rhc)):
    best_state_rhc, best_fitness_rhc, fitness_curve_rhc = mlrose.random_hill_climb(problem,
                                                      ...
                                                      init_state = init_state, restarts=10, curve=True, random_state = 1)
    best_fitness_rhcs.append(best_fitness_rhc)
    iteration_rhc.append(len(fitness_curve_rhc))
...
for i in range(len(max_iters_sa)):
    best_state_sa, best_fitness_sa, fitness_curve_sa = mlrose.simulated_annealing(problem, schedule = schedule,
                                                      max_attempts = 10, max_iters = max_iters_sa[i],
                                                      init_state = init_state, curve=True, random_state = 1)
    best_fitness_sas.append(best_fitness_sa)
    iteration_sa.append(len(fitness_curve_sa))

#===========================================================================================
max_iters_ga = [5,10,15,20,25,50,100,500,1000]
best_fitness_gas = []
iteration_ga = []
...
plt.grid(True)
plt.tight_layout()
plt.savefig('4_peaks_Number of Iteration Required for Converging.png',dpi=600)
